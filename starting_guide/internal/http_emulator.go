...
func (e *HTTPEmulator) getConfig(ctx context.Context) (*models.ConfigObject, error) {
...
func (e *HTTPEmulator) sendEvents(ctx context.Context, tags []*models.TagValueObject) error {
	requestCtx, cancel := context.WithTimeout(ctx, e.timeout)
	defer cancel()
...
func (e *HTTPEmulator) onStart(ctx context.Context) error {
	now := sdk.Now()
...
func (e *HTTPEmulator) onShutdown(ctx context.Context) error {
	now := sdk.Now()
	err := e.sendEvents(ctx, []*models.TagValueObject{
		// set agent status
		{
